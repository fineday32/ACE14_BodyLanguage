...
\begin{figure}[!h]
\centering
\includegraphics[width=0.9\columnwidth]{Figures/Topic1.png}
\caption{(a) Confusing with different language speakers, (b) Playing cooperative games via Internet, (c) Using body language as a communication manner}
\label{fig:Topic1}
\end{figure}
