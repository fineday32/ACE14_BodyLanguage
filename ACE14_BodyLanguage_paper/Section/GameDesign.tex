...
GameFlow\cite{GD1} discussed how game difficulty and players' skill levels affect whether players would perceive the experience as boring, fun, and frustrating. As shown Figure~\ref{fig:GD_F1}, if the difficulty is greater than the player's skills, the experience is frustrating. On the other hand, if the difficulty is less than the player's skills, the experience will be boring.
...
Our observation from the previous study indicated that playing a cooperative game with a partner that did not have a common language significantly decreased players' skill level. At a difficulty level that is designed to be fun for players with common languages, that difficulty level would be too challenging for players that could not communicate through language and leads to a frustrating experience. 

One way to solve this problem is to decrease the game's difficulty. However, this method makes the experience boring for players that had common languages. By supporting body language, players without common languages would be able to increase their skill level, and potential move the experience from frustrating to fun (as shown in Figure~\ref{fig:GD_F1}).  
