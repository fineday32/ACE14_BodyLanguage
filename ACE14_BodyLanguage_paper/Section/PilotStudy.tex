\section{Language Barrier meets\\ Current Cooperative Games}
...
We selected 3 popular cooperative games currently on the market that had distinct gameplay and cooperation needs: 1) \textit{Rocketbirds: Hardboiled Chicken}, a cooperative action game, 2) \textit{Portal 2}, a cooperative puzzle game, and 3) \textit{Monaco}, a cooperative stealth game. All three games supported real-time voice chat. [XXX need more game play description for each game]

In order to simulate cooperative gameplay over the Internet, pairs of players were placed in two different rooms and used headphones to communicate with each other. Participants played each of the three games for 30 minutes, and filled out an eSFQ\cite{eSFQ} questionnaire after each game. We also conducted an open-ended interview to understand their gaming experience at the end of the session. 
...
% \renewcommand\arraystretch{1.2}
  ...
  !{\vrule width2pt}}
    \Xhline{2px}
    \tabhead{Game} &
    \multicolumn{1}{c!{\vrule width2pt}}{\tabhead{Feedback from Players without Common Languages}} \\
    \Xhline{2px}
    Rockebirds & 
    \begin{itemize}
